    ...
    return (
        <DefaultLayout>
                    ...
                    <div>
                        <div className='space-y-4'>
                            ...
                            <p className='text-muted-foreground'>
                                ...
                                software development, exploring the latest
                                trends, tools, and techniques. Whether you're a
                                seasoned developer or just starting out, this
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-4">
                <img src="/placeholder.svg" alt="Host Avatar" width={80} height={80} className="rounded-full" />
                <div>
                  <h3 className="font-medium">John Doe</h3>
                  <p className="text-muted-foreground">
                    John is a seasoned software engineer with over 10 years of experience in the industry. He's
                    passionate about sharing his knowledge and helping others grow their coding skills.
                  </p>
                </div>
              </div>
            </CardContent>
