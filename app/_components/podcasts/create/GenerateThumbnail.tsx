      ...
      {isAiThumbnail ? (
        <div className="flex flex-col gap-5">
          <div className="mt-5 flex flex-col gap-2.5">
            ...
            <Textarea 
              className="input-class font-light focus-visible:ring-offset-orange-500"
          ...
          <Button type="submit" className="text-16 bg-orange-500 py-4 font-bold text-white" onClick={generateImage}>
            {isImageLoading ? (
              <>
                Generating
