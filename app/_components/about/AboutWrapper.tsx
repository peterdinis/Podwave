    ...
    return (
        <DefaultLayout>
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-md mt-4">
                ...
                <div className="mt-4">
                    <h2 className="text-xl font-semibold mb-2">Create Your Own Podcasts with AI Assistance</h2>
                    <p className="text-lg">
                ...
                <div className="mt-4">
                    <h2 className="text-xl font-semibold mb-2">Discover and Review Podcasts</h2>
                    <p className="text-lg">
